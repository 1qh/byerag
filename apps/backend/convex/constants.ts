...
const CLAUDE_SESSIONS_PATH = '/home/user/.claude-sessions'
const CLAUDE_TMP_PATH = '/home/user/.claude-tmp'
const CLAUDE_SHARED_MEMORY_PATH = '/home/user/.claude-shared-memory'
