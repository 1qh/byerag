...
check('hr-u department === HR', findDept('hr-u@example.com') === 'HR', `dept=${findDept('hr-u@example.com')}`)
check('it-u department === IT', findDept('it-u@example.com') === 'IT', `dept=${findDept('it-u@example.com')}`)
check(
