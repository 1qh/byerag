...
const PolicyPage = (): React.ReactElement => {
  ...
  useEffect(() => { if (typeof current === 'string') setText(current) }, [current])
  ...
  return (
    <div className="space-y-3 p-6">
      ...
      <p className="text-muted-foreground text-sm">Used by the policy classifier on every upload to accept/reject documents.</p>
      <textarea
