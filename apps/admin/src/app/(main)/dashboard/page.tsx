    ...
    <div className="space-y-8 p-6">
      ...
      <section>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {pivot.length === 0 ? (
              <tr><td colSpan={5} className="py-4 text-muted-foreground">No usage yet this cycle.</td></tr>
            ) : (
              pivot.map(r => (
                <tr key={`${r.owner}|${r.model}`} className="border-b">
      ...
      <section>
        <h2 className="mb-2 font-semibold text-lg">Gradebook ({grade.users.length} × {grade.topics.length})</h2>
